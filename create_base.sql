...
CREATE TABLE [dbo].[Pass_in_Flights] (
	[Flights_no] [int] NOT NULL ,
...
ALTER TABLE [dbo].[Airports] WITH NOCHECK ADD 
...
ALTER TABLE [dbo].[Pass_in_Flights] WITH NOCHECK ADD 
...
ALTER TABLE [dbo].[Travelers] WITH NOCHECK ADD 
...
ALTER TABLE [dbo].[Flights] WITH NOCHECK ADD 
...
ALTER TABLE [dbo].[Pass_in_Flights] ADD 
	CONSTRAINT [FK_Pass_in_Flights_Travelers] FOREIGN KEY 
	(
		[ID_psg]
	) REFERENCES [dbo].[Travelers] (
		[ID_psg]
	),
	CONSTRAINT [FK_Pass_in_Flights_Flights] FOREIGN KEY 
	(
		[Flights_no]
...
ALTER TABLE [dbo].[Flights] ADD 
	CONSTRAINT [FK_Flights_Airports] FOREIGN KEY 
	(
		[ID_comp]
